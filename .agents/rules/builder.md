...
- **Dependency & Propagation Checks**: Before changing any function signatures, database schemas, or API parameters, you MUST check the [Ripple Map](file:///home/dnguyen029/telemetry-dashboard/.agents/docs/RIPPLE_MAP.md) and synchronize all downstream files in the same turn.
...
- **Environment Compliance**: Run python scripts using the locked virtual environment interpreter `/home/dnguyen029/telemetry-dashboard/.venv/bin/python` to avoid environment resolution conflicts.
