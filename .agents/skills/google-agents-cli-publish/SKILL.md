...
agents-cli publish gemini-enterprise \
  --agent-runtime-id projects/123456/locations/us-west1/reasoningEngines/789 \
...
agents-cli publish gemini-enterprise \
  ...
  --agent-card-url https://my-service-abc123.us-west1.run.app/a2a/app/.well-known/agent-card.json \
  --gemini-enterprise-app-id projects/123456/locations/global/collections/default_collection/engines/my-app \
...
```bash
export AGENT_RUNTIME_ID="projects/123456/locations/us-west1/reasoningEngines/789"
