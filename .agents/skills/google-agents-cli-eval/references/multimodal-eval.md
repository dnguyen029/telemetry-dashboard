...
- **Response/rubric evaluators** — evaluate the agent's _text response_. If the agent produces a text answer from multimodal input (e.g., describes an image), these metrics work normally.
