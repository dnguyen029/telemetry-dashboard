...
| :--- | :--- | :--- |
| **`AGENTS.md`** (Swarm Mandates) | [`.agents/rules/AGENTS.md`](file:///home/dnguyen029/telemetry-dashboard/.agents/rules/AGENTS.md), [`bootstrap.md`](file:///home/dnguyen029/telemetry-dashboard/bootstrap.md) | Verify rule definitions are parsed cleanly by the router |
| **`bootstrap.md`** (Host Specs) | [`.agents/rules/workspace_context.md`](file:///home/dnguyen029/telemetry-dashboard/.agents/rules/workspace_context.md), [`.agents/rules/GEMINI.md`](file:///home/dnguyen029/telemetry-dashboard/.agents/rules/GEMINI.md) | Ensure virtual environment runtimes match active config |
...
| Primary Anchor | Downstream Echoes (MUST SYNC) | Check Command / Method |
| :--- | :--- | :--- |
| **`mcp_config.json`** (Local) | [`~/.gemini/antigravity-ide/mcp_config.json`](file:///home/dnguyen029/.gemini/antigravity-ide/mcp_config.json), [`app_build/verify_mcp_connections.py`](file:///home/dnguyen029/telemetry-dashboard/app_build/verify_mcp_connections.py) | Run `python app_build/verify_mcp_connections.py` to confirm 7/7 connected |
| **`.env`** (Environment Keys) | [`mcp_config.json`](file:///home/dnguyen029/telemetry-dashboard/mcp_config.json), [`~/.gemini/antigravity-ide/mcp_oauth_tokens.json`](file:///home/dnguyen029/.gemini/antigravity-ide/mcp_oauth_tokens.json) | Check environment keys are sourced cleanly |
